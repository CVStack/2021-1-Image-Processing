...
//
//	Mat mat_grayScale(Size(300, 300), CV_8UC1, Scalar(50, 0, 0, 0)); //grayscale
//	Mat mat_trueColor(Size(300, 300), CV_8UC3, Scalar(50, 60, 100, 0)); //truecolor
//
//	imshow("GrayScale", mat_grayScale);
//	waitKey();
//	imshow("TrureScale", mat_trueColor);
//	waitKey();
//
